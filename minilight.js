...
(function (root, factory) {
    ...
    var _window          = window,
        ...
        color            = ';color:',
        minilightOptions = ["#222","#F50","#000","#06F","#E80","#930","#930","#6F6","#888","#6F6","#6F6"],
    ...
    var reset = function(cls) {
        // nodes to highlight
        microlighted = _document.getElementsByClassName(cls||'minilight');
